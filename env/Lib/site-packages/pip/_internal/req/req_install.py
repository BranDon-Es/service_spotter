...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # Information about the precise_location of the artifact that was downloaded . This
        ...
        # Temporary build precise_location
    ...
    def update_editable(self) -> None:
        if not self.link:
            logger.debug(
                "Cannot update repository at %s; repository precise_location is unknown",
                self.source_dir,
            )
            return
